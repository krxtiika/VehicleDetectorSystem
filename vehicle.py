...
while True:
    ...
    cv2.line(frame1,(25,count_line_position),(1200,count_line_position),(250,100,0),3)
    ...
    for (i,c) in enumerate(counterShape):
        ...
        for (x,y) in detect:
            if y<(count_line_position+offset) and y>(count_line_position-offset):
                counter+=1
                cv2.line(frame1,(25,count_line_position),(1200,count_line_position),(0,100,255),3)
                detect.remove((x,y))
